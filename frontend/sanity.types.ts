...
// Query: *[_type == "festivalCity" && defined(slug.current)] | order(orderRank asc){    _id,    "slug": slug.current,    title,    cityName,    themeKey,    heroImage{        ...,  asset->{    _id,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }    }  }
