      ...
      <main className="mx-auto max-w-4xl px-4 py-12 md:px-8 md:py-16">
        ...
        <article className="space-y-8 rounded-3xl border border-border bg-card p-6 shadow-sm md:p-12">
          ...
          <section className="space-y-4 leading-relaxed text-muted-foreground">
            ...
            <p>
              Придбання квитків здійснюється через уповноважені квиткові оператори. Квиток надає право одноразового або багаторазового входу (залежно від категорії квитка) на територію проведення фестивалю «Країна Мрій 2026» у визначені дати (19–20 вересня 2026 року).
            </p>
          </section>
