...
export const metadata: Metadata = {
  ...
  description:
    "Ювілейний етнофестиваль «Країна Мрій» 2026 у Львові | 19–20 вересня, Парк культури. Олег Скрипка, Гайдамаки, Кому Вниз, Лос Янковерс. Квитки онлайн!",
  alternates: {
    canonical: "/",
  },
  openGraph: {
...
export default async function HomePage() {
  ...
  const jsonLdEvent = {
    ...
    startDate: "2026-09-19T12:00:00+03:00",
    endDate: "2026-09-20T22:00:00+03:00",
